import { clearCurrentOrder, createOrder, fetchAllOrders, fetchOrderByNumber, fetchOrders, initialState, orderReducer, resetOrderState, setOrderModalData } from "../../services/slices/orderSlice";
...
describe('orderSlice reducer', () => {
    test('initial state', () => {
        expect(orderReducer(undefined, { type: 'unknown' }))
...
describe('async actions', () => {
    ...
    describe('fetchOrderByNumber', () => {
        test('pending', () => {
            const state  = orderReducer({...initialState, currentOrder: mockOrder}, {type: fetchOrderByNumber.pending.type});
            expect(state.currentOrder).toBeNull();
        });
        test('fulfilled', () => {
            const action = { 
